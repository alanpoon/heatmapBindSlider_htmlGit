...
var CalHeatMap = function(valueArray) {
//valueArray are where we push our data to;
	"use strict";
	...
	this.paint = function(navigationDir) {
		...
		;
		//append to subDomainPosY using rect
...
CalHeatMap.prototype = {
	...
	getSubDomainColumnNumber: function(d) {
		...
		if (this.options.rowLimit > 0) {
			...
			var i = this._domainType[this.options.subDomain].defaultColumnNumber;
